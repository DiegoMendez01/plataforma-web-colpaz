...
(
    ...
    `type` ENUM('Texto', 'Imagen', 'Video', 'Documento') NOT NULL COMMENT 'Tipo de contenido (puedes asignar valores específicos según tus necesidades)',
