...
require_once("../../models/teachercourse.php");
...
<head lang="es">
    ...
    ?>
    <title>Aula Virtual::Cursos Profesor <?= $teachercourseData['name'] ?></title>
</head>
		...
		<div class="container-fluid">
			<header class="section-header">
				<div class="tbl">
					<div class="tbl-row">
						<div class="tbl-cell">
							<h3>Curso profesor <?= $teachercourseData['name'] ?> [ID: <?= studentteacherData['id'] ?>]</h3>
							<ol class="breadcrumb breadcrumb-simple">
								<li><a href="../teachercourse/">Inicio</a></li>
								<li class="active">Curso profesor <?= teachercourseData['name'] ?> [ID: <?= studentteacherData['id'] ?>]</li>
							</ol>
						</div>
					</div>
				</div>
				...
				<table id="teachercourse_view_data" class="table table-bordered table-striped table-vcenter js-dataTable-full">
                    <tbody>
                        <tr>
                            ...
                            <td><?= $teachercourseData['name'] ?></td>
                        </tr>
                        <tr>
                            <th style="width: 30%;">Periodo</th>
                            <td><?= teachercourseData['description'] ?></td>
                        </tr>
                        <tr>
...
<?php
        ...
        header("Location:" . Connect::route() . "views/teachercourse/");
        exit;
    }
}else{
