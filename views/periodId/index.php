...
<head>
    ...
    <title>Aula Virtual:Gestion Identificacion del periodo Academico</title>
</head>
...
<body class="with-side-menu">
    ...
    <?php require_once("modalGestionPeriodId.php"); ?>
    
    <?php require_once ("../mainJs/js.php"); ?>
    
    <script src="periodId.js" type="text/javascript"></script>
</body>
</html>
