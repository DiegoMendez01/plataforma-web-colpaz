    ...
    public function confirmedEmail($id_user = null, $emailSubmmit = null)
    {
        ...
        if(empty($answer)){
            ...
            if(empty($answer)){
                         ...
                         <tr style="border-collapse:collapse">
                          <td valign="top" align="center" style="padding:0;Margin:0;width:520px">
                           <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                             <tr style="border-collapse:collapse">
                              <td align="left" style="padding:0;Margin:0"><h1 style="Margin:0;font-family:helvetica, "helvetica neue", arial, verdana, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:30px;font-style:normal;font-weight:normal;line-height:36px;color:#4A7EB0">Confirmación de Correo Electrónico '.$dataUser['id'].'</h1></td>
                             </tr>
                             <tr style="border-collapse:collapse">
                ...
                $this->setFrom($this->gestorCorreo, "Confirmar Correo Electronico - ".$dataUser['id']);
                
                $this->CharSet      = 'UTF8';
                $this->addAddress($dataUser['email']);
                $this->IsHTML(true);
        ...
        '
            <tr style="border-collapse:collapse">
              <td style="padding:0;Margin:0">
                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, "helvetica neue", helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">Estimado '.$userData['name'].' '.$userData['lastname'].'</p>
