...
class TeacherCourses extends Database
{
    ...
    */
    ...
    /*
     * Funcion para insertar a un docente en un curso mediante un formulario
     */
    public function insertTeacherCourse($user_id, $course_id, $classroom_id, $period_id, $degree_id, $idr)
    {
        ...
        $sql = '
            ...
            FROM
                teacher_courses
            WHERE
                user_id = ? AND course_id = ? AND classroom_id = ? AND period_id = ? AND degree_id = ? AND is_active != 0 AND idr = ?
        ';
    ...
    /*
     * Funcion para actualizar a un docente en un curso mediante un formulario
     */
    public function updateTeacherCourse($id, $user_id, $course_id, $classroom_id, $period_id, $degree_id, $idr)
    {
        $conectar = parent::connection();
        parent::set_names();
